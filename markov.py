...
#     # get a inital link value
#     # add the two words in the link value to words
#     #get one word from the 
#     """"{('a', 'fox?'): ['Would'],
#  ('Sam', 'I'): ['am?'],
...
#     print("this is chains link ", chains[link])
#     words.extend(chains[link])
    
#     for i in words:
#         new_text_keys=(words[0])
#         print(new_text_keys)
#         for val in new_text_keys:
